...
public class mainone {
    ...
    public static void main(String args[]) throws Exception {
        ...
        switch(whatToDo) {
            ...
            case 2:
                ...
                if(j > 0){
                    hashed2 = toHexString(getSHA(t));
                    written = written + hashed2 + ", ";
                }
                writer.close();
    ...
    public static String checkLoop2(boolean exists) throws Exception{
        Scanner sc = new Scanner(System.in);
        String newInput = "";
        ...
        while (newInput.equals("")) {
            if(num == 0) {
                if (exists) {
                    System.out.println("Sorry. That password has been taken already. Choose another password.");
                    newInput = "";
                }
                else{
                    return newInput;
                ...
                try {
                    ...
                    System.out.println("That password has been taken already. Choose another password.");
                    newInput = sc.nextLine(); //loop it
                }
